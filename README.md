...
*   **🛠️ 實體工具調用 (Function / Tool Calling)：**
...
用戶輸入 ➡️ Router (總機判斷意圖) 
                  ┣ ➡️ Tech Agent 🔄 [Tool: 查機房/建工單]
                  ┣ ➡️ Sales Agent 🔄 [Tool: 查合約/推方案]
                  ┗ ➡️ General Agent (邊界防範/委婉拒絕)
